...
namespace AWoodATS
{
    public class SubmitShipingDocument
    {
        ...
        [XmlRoot(ElementName = "SubmitDocument", Namespace = "http://tempuri.org")]
        public class SubmitDocument
        {
            [XmlElement(ElementName = "ShippingSchedule", Namespace = "rrn:org.xcbl:schemas/xcbl/v4_0/materialsmanagement/v1_0/materialsmanagement.xsd")]
        ...
        public class Body
        {
            [XmlElement(ElementName = "SubmitDocument", Namespace = "http://tempuri.org")]
            public SubmitDocument SubmitDocument { get; set; }
        }
